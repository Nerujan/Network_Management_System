...
<body>
    ...
    <div class="container">
        <form action="addData.php" method="post" class="myfm">
            ...
            <div>
                <label for="switchLocation">Switch Location: </label>
        ...
        <select name="menu2" id="menu2" required>
            ...
            <div>
                <label>Switch Port ID: </label><input type="text" name="switchID" size="30">
            </div>
            <div>
                <label>User Name: </label><input type="text" name="userName" size="30">
            </div>
            <div>
                <label>Terminal Location: </label><input type="text" name="portLocation" size="30">
            </div>
            <div>
                <label>VLAN: </label><input type="text" name="vlan" size="30">
            </div>
            <div>
                <label>Terminal IP: </label><input type="text" name="portIP" size="30">
            </div>
            <div>
                <label>Devices Connected: </label><input type="text" name="goods" size="30">
            </div>
            <div>
