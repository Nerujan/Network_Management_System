<?php
session_start();
if(!(isset($_SESSION['name'])&& isset($_SESSION['role'])&& $_SESSION['role']=='staff')){
...
<body>
	...
	<input type="submit" id="search" name="view" value="Filter" >
    <input type="submit" id="search"name="display" value="View All" >
</form>
